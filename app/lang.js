...
const LANG = {
  en: {
    ...
    signals: {
      ...
      thinktank:    { icon:'🧠', name:'Think Tank & Expert',    weight:'10%', summary:'Policy sentiment & consensus',        detail:'NLP sentiment scoring on publications, weighted by institute reliability. Note: reflects recommendations, not predictions.', sources:['Mitvim RSS','ALLMEP RSS','FMEP RSS','INSS RSS','JISS RSS'], update:'Every 30 min' },
